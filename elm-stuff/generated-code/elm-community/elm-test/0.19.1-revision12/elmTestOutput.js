...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		var toDuration = function (durationInMs) {
			var seconds = A2($elm$core$Basics$modBy, (durationInMs / 1000) | 0, 60);
			var minutes = A2($elm$core$Basics$modBy, (durationInMs / (1000 * 60)) | 0, 60);
			var hours = A2($elm$core$Basics$modBy, (durationInMs / ((1000 * 60) * 60)) | 0, 24);
			var days = (durationInMs / (((1000 * 60) * 60) * 24)) | 0;
			return {days: days, hours: hours, minutes: minutes, seconds: seconds};
		};
		var diffMillis = $elm$time$Time$posixToMillis(t2) - $elm$time$Time$posixToMillis(t1);
		return (diffMillis >= 0) ? $elm$core$Maybe$Just(
			toDuration(diffMillis)) : $elm$core$Maybe$Nothing;
	});
var $author$project$Util$Time$formatDuration = function (duration) {
	...
	var formatPart = F2(
		function (unit, value) {
			return (value > 0) ? ($elm$core$String$fromInt(value) + (' ' + (A2(unitString, unit, value) + ' '))) : '';
		});
	return _Utils_ap(
		A2(formatPart, 'day', days),
		_Utils_ap(
			A2(formatPart, 'hour', hours),
			_Utils_ap(
				A2(formatPart, 'minute', minutes),
				A2(formatPart, 'second', seconds))));
};
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\MainTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\PostsConfigTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\PostsViewTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\PostTests.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\SimulatedEffect.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\TestData.elm', 'C:\\Users\\Tudor\\Desktop\\Facultate\\An3\\FP\\Project1\\tests\\TestUtils.elm']),
		processes: 8,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-9024-1";
var net = require('net'),
